...
struct alloc_metadata {
    unsigned long allocation_size;      // # bytes allocated by user
    bool mallocd;                       // memory allocated by malloc
    bool active;                        // memory wasn't free'd 
    const char* file;                   // file of malloc() call
    long line;                          // line of malloc() call
};
